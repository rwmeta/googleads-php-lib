...
if (!class_exists("AddressInfo", false)) {
  ...
  class AddressInfo {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201802";
...
if (!class_exists("AdwordsUserListService", false)) {
  ...
  class AdwordsUserListService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/rm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/rm/v201802/AdwordsUserListService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/rm/v201802/AdwordsUserListService";
    /**

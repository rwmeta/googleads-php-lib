...
if (!class_exists("CustomerService", false)) {
  ...
  class CustomerService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/mcm/v201802/CustomerService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201802/CustomerService";
    /**

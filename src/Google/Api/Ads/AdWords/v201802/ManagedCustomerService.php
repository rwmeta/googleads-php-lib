...
if (!class_exists("ManagedCustomerLabel", false)) {
  ...
  class ManagedCustomerLabel {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201802";
...
if (!class_exists("ManagedCustomerService", false)) {
  ...
  class ManagedCustomerService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/mcm/v201802/ManagedCustomerService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201802/ManagedCustomerService";
    /**

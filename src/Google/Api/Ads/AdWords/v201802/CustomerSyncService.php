...
if (!class_exists("AdGroupChangeData", false)) {
  ...
  class AdGroupChangeData {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/ch/v201802";
...
if (!class_exists("CustomerSyncService", false)) {
  ...
  class CustomerSyncService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/ch/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/ch/v201802/CustomerSyncService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/ch/v201802/CustomerSyncService";
    /**

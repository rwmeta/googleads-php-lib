...
if (!class_exists("TargetingIdeaService", false)) {
  ...
  class TargetingIdeaService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/o/v201802";
    const ENDPOINT = "https://adwords.google.com/api/adwords/o/v201802/TargetingIdeaService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/o/v201802/TargetingIdeaService";
    /**

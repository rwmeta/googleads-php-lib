...
if (!class_exists("OfflineCallConversionFeedService", false)) {
  ...
  class OfflineCallConversionFeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/OfflineCallConversionFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/OfflineCallConversionFeedService";
    /**

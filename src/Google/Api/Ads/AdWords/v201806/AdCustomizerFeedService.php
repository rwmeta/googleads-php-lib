...
if (!class_exists("AdCustomizerFeedService", false)) {
  ...
  class AdCustomizerFeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/AdCustomizerFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/AdCustomizerFeedService";
    /**

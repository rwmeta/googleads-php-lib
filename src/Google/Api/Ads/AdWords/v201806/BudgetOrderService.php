...
if (!class_exists("BillingAccount", false)) {
  ...
  class BillingAccount {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/billing/v201806";
...
if (!class_exists("BudgetOrderService", false)) {
  ...
  class BudgetOrderService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/billing/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/billing/v201806/BudgetOrderService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/billing/v201806/BudgetOrderService";
    /**

...
if (!class_exists("AccountLabelService", false)) {
  ...
  class AccountLabelService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/mcm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/mcm/v201806/AccountLabelService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/mcm/v201806/AccountLabelService";
    /**

...
if (!class_exists("DynamicSearchAd", false)) {
   ...
   * 
   * <p>Note: we recommend using the ExpandedDynamicSearchAd type, introduced in v201806, rather than
...
if (!class_exists("AdGroupAdService", false)) {
  ...
  class AdGroupAdService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/AdGroupAdService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/AdGroupAdService";
    /**

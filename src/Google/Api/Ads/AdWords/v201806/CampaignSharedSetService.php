...
if (!class_exists("CampaignSharedSetService", false)) {
  ...
  class CampaignSharedSetService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/CampaignSharedSetService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/CampaignSharedSetService";
    /**

...
if (!class_exists("OfflineConversionFeedService", false)) {
  ...
  class OfflineConversionFeedService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/OfflineConversionFeedService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/OfflineConversionFeedService";
    /**

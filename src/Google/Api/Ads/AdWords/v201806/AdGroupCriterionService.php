 ...
 *
 * @package    Google_Api_Ads_AdWords_v201806
 * @subpackage v201806
...
if (!class_exists("BiddingStrategyConfiguration", false)) {
   ...
   * 
   * <p class="note"><b>Note:</b> Starting with v201806, bidding strategies can only be set on
...
if (!class_exists("AdGroupCriterionService", false)) {
  ...
  class AdGroupCriterionService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/AdGroupCriterionService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/AdGroupCriterionService";
    /**

...
if (!class_exists("CampaignGroupPerformanceTargetService", false)) {
  ...
  class CampaignGroupPerformanceTargetService extends AdWordsSoapClient {
    ...
    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";
    const ENDPOINT = "https://adwords.google.com/api/adwords/cm/v201806/CampaignGroupPerformanceTargetService";

    /**
     * The endpoint of the service
     * @var string
     */
    public static $endpoint = "https://adwords.google.com/api/adwords/cm/v201806/CampaignGroupPerformanceTargetService";
    /**

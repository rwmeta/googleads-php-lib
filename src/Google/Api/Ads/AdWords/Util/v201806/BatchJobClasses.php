 ...
 *             Version 2.0
 */
require_once 'Google/Api/Ads/AdWords/v201806/AdGroupAdService.php';
require_once 'Google/Api/Ads/AdWords/v201806/AdGroupBidModifierService.php';
require_once 'Google/Api/Ads/AdWords/v201806/AdGroupCriterionService.php';
require_once 'Google/Api/Ads/AdWords/v201806/AdGroupExtensionSettingService.php';
require_once 'Google/Api/Ads/AdWords/v201806/AdGroupService.php';
require_once 'Google/Api/Ads/AdWords/v201806/BudgetService.php';
require_once 'Google/Api/Ads/AdWords/v201806/CampaignCriterionService.php';
require_once 'Google/Api/Ads/AdWords/v201806/CampaignExtensionSettingService.php';
require_once 'Google/Api/Ads/AdWords/v201806/CampaignService.php';
require_once 'Google/Api/Ads/AdWords/v201806/CustomerExtensionSettingService.php';
require_once 'Google/Api/Ads/AdWords/v201806/FeedItemService.php';

if (!class_exists("ErrorList", false)) {
  class ErrorList {

    const WSDL_NAMESPACE = "https://adwords.google.com/api/adwords/cm/v201806";

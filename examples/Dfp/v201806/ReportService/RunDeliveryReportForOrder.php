...
require_once 'Google/Api/Ads/Dfp/Util/v201802/DateTimeUtils.php';
require_once 'Google/Api/Ads/Dfp/Util/v201802/ReportDownloader.php';
require_once 'Google/Api/Ads/Dfp/Util/v201802/StatementBuilder.php';
...
try {
  ...
  $reportService = $user->GetService('ReportService', 'v201802');

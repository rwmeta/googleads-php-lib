...
require_once 'Google/Api/Ads/Dfp/Util/v201710/DateTimeUtils.php';
require_once 'Google/Api/Ads/Dfp/Util/v201710/ReportDownloader.php';
...
try {
  ...
  $reportService = $user->GetService('ReportService', 'v201710');

 ...
 * https://developers.google.com/doubleclick-publishers/docs/reference/v201710/PublisherQueryLanguageService#Line_Item
 *
 * PHP version 5
 *
...
require_once 'Google/Api/Ads/Dfp/Util/v201710/Pql.php';
...
try {
  ...
  $pqlService = $user->GetService('PublisherQueryLanguageService', 'v201710');
